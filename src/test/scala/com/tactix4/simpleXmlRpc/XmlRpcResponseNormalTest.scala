...
class XmlRpcResponseNormalTest extends FunSuite with PropertyChecks{
  ...
  /**
   * Generate some valid responses - feed them into [[com.tactix4.simpleXmlRpc.XmlRpcResponseNormal]]
   ...
   * feed them into [[com.tactix4.simpleXmlRpc.XmlRpcResponseNormal]]
   */
